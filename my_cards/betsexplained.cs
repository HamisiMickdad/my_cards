...
namespace my_cards
{
    [Activity(Label = "betsexplained")]
    public class betsexplained : forebet
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            myWebView.LoadUrl("http://www.bestbettingsites.co.uk/betting-guide/football-bets/");
            ...
            SupportActionBar.Title = "HOW TO BET?";
